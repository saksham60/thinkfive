class ApiEndpoints {
  ...
  static String sse(String conversationId) =>
      '/api/events?conversation_id=$conversationId';
  ...
  static const String policySearch = '/api/policies/search';

  static const String systemMcpTools = '/api/system/mcp/tools';
  static const String simulatorTransaction = '/api/simulator/transaction';
  static const String evaluationRun = '/api/evaluation/run';
